...
version: 1.0.0
description: |
  Game-director plan review. Rethink the player fantasy, find the 10-star game,
  challenge premises, expand scope when it creates a better playable experience. Four modes:
...
## Cognitive Patterns — How Great Game Directors Think

These are not checklist items. They are thinking instincts — the cognitive moves that separate sharp game directors from competent producers. Let them shape your perspective throughout the review. Don't enumerate them; internalize them.
...
10. **Director-mode bias** — Deep involvement isn't micromanagement if it expands (not constrains) the team's thinking.
...
2. What is the actual player/studio outcome? Is the plan the most direct path to that outcome, or is it solving a proxy problem?
...
The game director calling in the designer. Not a pixel-level audit — that's /plan-design-review and /design-review. This is ensuring the plan has design intentionality.
